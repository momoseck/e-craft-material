...
export class AdminManagerService {
  ...
  host: string = API_URI + 'admin/';
  hostList: string = API_URI + 'admins/';
  header: any;
  ...
  getRegions(): Observable<Region[]> {
    return this.http.get<Region[]>(this.hostList + 'listRegions', { headers: this.header });
  }
  ...
  getDepartements(): Observable<Departement[]> {
    return this.http.get<Departement[]>(this.hostList + 'listDepartements', { headers: this.header });
  }
  ...
  getChambremetier(): Observable<Chambremetier[]> {
    return this.http.get<Chambremetier[]>(this.hostList + 'listChambres', { headers: this.header });
  }
  ...
  getGouvernance(): Observable<Gouvernance[]> {
    return this.http.get<Gouvernance[]>(this.hostList + 'listGouvernances', { headers: this.header });
  }
  ...
  getSection(): Observable<Section[]> {
    return this.http.get<Section[]>(this.hostList + 'listSections', { headers: this.header });
  }
  ...
  getRole(): Observable<Role[]> {
    return this.http.get<Role[]>(this.hostList + 'listRoles', { headers: this.header });
  }
  getRol(role: string): Observable<Role> {
    return this.http.get<Role>(this.hostList + 'listRole/' + role, { headers: this.header });
  }
  // crud compte
  getCompte(): Observable<Compte[]> {
    return this.http.get<Compte[]>(this.hostList + 'listComptes', { headers: this.header });
  }
  ...
  // profession
  postProfession(profession: Professions): Observable<Professions> {
    return this.http.post<Professions>(this.host + 'saveProfession', profession, { headers: this.header });
  }
  getProfessions(): Observable<Professions[]> {
    return this.http.get<Professions[]>(this.hostList + 'listProfessions', { headers: this.header });
  }
  getProfession(id: number): Observable<Professions> {
    return this.http.get<Professions>(this.hostList + 'listProfessions/' + id, { headers: this.header });
  }

  // crud agent chambre des metier

  getAgentChambre(): Observable<Agentchambre[]> {
    return this.http.get<Agentchambre[]>(this.hostList + 'listAgentCh', { headers: this.header });
  }
  ...
  getAgentGouvernance(): Observable<Agentgouvernance[]> {
    return this.http.get<Agentgouvernance[]>(this.hostList + 'listAgentGouv', { headers: this.header });
  }
  ...
  postChambre(formdata: FormData): Observable<any> {
    return this.http.post<any>(this.host + 'saveChambres', formdata, { headers: this.header });
  }
}
